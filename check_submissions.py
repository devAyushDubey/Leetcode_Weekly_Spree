...
def write_to_readme(filename, students_list):
    ...
    mdFile.new_line()
    mdFile.new_paragraph("This is an automated repo where your submission is automatically counted and ranking is displayed.", bold_italics_code='b', color='purple')
    mdFile.new_line()
